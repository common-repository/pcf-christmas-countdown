...
function wpshout_register_widgets() {
	register_widget( 'pcfcc_Widget');
}
add_action( 'widgets_init', 'wpshout_register_widgets' );

class pcfcc_Widget extends WP_Widget {

	function pcfcc_Widget() {
		// Instantiate the parent object
		parent::__construct(
	            'pcfcc_widget', // Base ID
        	    __('Christmas Countdown', 'text_domain'), // Name
 	           array( 'description' => __( 'Christmas Countdown', 'text_domain' ), ) // Args
		);
	}
...
<?php
	...
	function widget($args, $instance) {
        ...
        pcfcc_countdown($instance['id'], $instance['type']);
